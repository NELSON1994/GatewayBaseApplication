package com.gatewayDemo2.GatewayOwnSettingProject.packager;
 ...
 * @version $Id: Transport_Packager.java 2594 2009-02-09 16:41:31Z apr $
 * @see ISOPackager
 * @see ISOBasePackager
 * @see ISOComponent
 */
public class TransportPackager extends ISOBasePackager {
    private static final boolean pad = false;

    public TransportPackager() {
        super();
        ISOFieldPackager[] fld = {
                ...
                /*008*/ new IFB_NUMERIC(20, "Customer category", pad),
                ...
                /*022*/ new IFB_NUMERIC(15, "Transaction type", pad),
                ...
                /*040*/ new IFB_NUMERIC(999, "Transaction data for STC transactions", pad),
                ...
                /*062*/ new IFB_LLLBINARY(999, "Reserved for private use"),
